    ...
    <div id="bio-container" className="slide-in">
      <section id="bio-section">
        ...
        <p>
          ...
          eye-watering red in Pascal, I felt like I'd figured out the secrets of
          the universe... needless to say, I was hooked. Fast forward to 2011,
          and I had graduated with a Bachelors Degree in Creative Computing from
          Goldsmiths University Of London. <br />
          <section id="image-section">
            <img src={me} alt="profile picture" id="profile-picture"></img>
          </section>
          <br /> After this deeply fulfilling but also consuming experience, I
          felt like I needed a bit of a change for a while. So I worked
          ...
          something out of nothing (which is my favourite thing to do) with all
          those lovely 1's and 0's. Nowadays, I spend most of my time coding,
          learning about something related to code, or scouring through Stack
          Overflow trying to figure out why the console's giving me a bit of
          attitude. And to be honest, I wouldn't have it any other way...
        </p>
      </section>
    </div>
  );
