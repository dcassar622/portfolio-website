const portfolioProjects = [
  {
    title: "GCHSS Marketing Department Website",
    subtitle: "A resource website for the Marketing Department at GCHSS",
    description: `This is a bespoke resource and news website that I built for the
                teachers and students in the Marketing Department at Giovanni
                Curmi Higher Secondary School. Built using React JS, HTML, CSS & Materialize CSS`,
    linkApp: "",
    linkCode: "https://github.com/dcassar622/gchss-marketing.git",
    linkCaseStudy: "",
    id: "gchss-card"
  },
  {
  ...
  {
    title: "Song Science",
    subtitle: " A Musical Analysis application",
    description: `Song Science uses Spotify's
              ...
              Vanilla Javascript, HTML, CSS &
              a bit of Materialize CSS for the
              search form popup
`,
    linkApp: "",
